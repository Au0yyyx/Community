...
local f=Instance.new("Frame");f.Name="CompactWebsiteShop";f.Size=UDim2.fromOffset(438,322);f.Position=UDim2.new(1,-452,.5,-161);f.BackgroundColor3=Color3.fromRGB(0,0,0);f.BorderSizePixel=0;f.Active=true;f.Draggable=true;f.Visible=false;f.Parent=gui;Instance.new("UICorner",f).CornerRadius=UDim.new(0,14);App.Frame=f;App.Gui=gui
...
label(f,"NULLSCAPE SHOP CALCULATOR",UDim2.fromOffset(14,8),UDim2.new(1,-28,0,25),Enum.Font.GothamBold,18,Color3.fromRGB(245,233,255))
...
label(f,"Shop",UDim2.fromOffset(14,116),UDim2.fromOffset(120,22),Enum.Font.GothamBold,16,Color3.fromRGB(245,233,255))
