...
local function setupStaminaChanger()
    ...
    local function build(role,side)
        ...
        box:AddSlider("FSK"..role.."Min",{Text="Minimum stamina",Default=p.Min,Min=-1000000,Max=0,Rounding=4,Callback=function(v)p.Min=v end})
...
for _, path in ipairs(addonPaths) do
    ...
    if fileName == "farthubsilentaim.lua" then
        addonUrl = "https://cdn.jsdelivr.net/gh/Au0yyyx/Community@9bb86ac9e0a56101a76564543a12176f81aad0b4/farthubsilentaim.lua"
    end
